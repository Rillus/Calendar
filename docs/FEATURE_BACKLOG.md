...
### 19. Event/Availability Integration
**Status**: Not Implemented  
**Priority**: 🟢 Medium  
**Description**: For Ticketlab - show ticket availability:
- Visual indicators for available dates
- Disable sold-out dates
- Show event dates
- Hover tooltips with availability info

**Current State**: No event/availability display.

**Acceptance Criteria**:
- Availability is visually clear
- Screen reader announces availability
- Integration with Ticketlab data

---

### 20. Customisable Colour Schemes
**Status**: Not Implemented  
**Priority**: 🟢 Medium  
**Description**: Allow custom colour palettes:
- User-defined month colours
- Accessibility validation (contrast checks)
- Preset themes
- Brand colour integration for Ticketlab

**Current State**: Fixed seasonal colour palette.

**Acceptance Criteria**:
- Custom colours maintain contrast
- Validation prevents inaccessible colours
- Easy to configure
...
### 23. Export/Share Functionality
**Status**: Not Implemented  
**Priority**: 🟢 Medium  
**Description**: Export selected dates:
...
### 24. D3.js Integration
**Status**: Not Implemented  
**Priority**: ⚪ Low  
**Description**: Advanced interactions and animations using D3.js (if needed):
- Complex animations
- Data visualisation
- Advanced interactions

**Note**: Only if vanilla JS proves insufficient.
